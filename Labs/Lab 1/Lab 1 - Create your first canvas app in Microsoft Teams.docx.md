...
8.  Fill in the **Choices** option with !!**Engineering Lab**!! under the **Label** field.
...
11. Continue adding the below two records in the table.
     ...
     !!**LED Display Unit**!! - !!**Testing Lab**!!

    !!**Digital Whiteboard**!! - **Engineering Lab** (To enter Engineering Lab, double click on the location field in
